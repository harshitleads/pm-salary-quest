...
const SalaryTierCard = ({ tier }: { tier: typeof salaryTiers[number] }) => {
  ...
  return (
    <button
      ...
      className={`${tier.gradient} group relative w-full overflow-hidden rounded-2xl p-6 text-left shadow-lg transition-all duration-300 hover:scale-[1.03] hover:shadow-2xl active:scale-[0.98]`}
    >
      ...
      <div className="relative z-10 flex flex-col gap-3">
        ...
        <span className="mt-2 inline-flex items-center gap-1 text-quiz-option font-semibold text-white underline-offset-4 group-hover:underline">
